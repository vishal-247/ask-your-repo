    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(251,182,206,0.14) 0%, transparent 70%)",
            top: 200,
            right: -80,
            filter: "blur(40px)",
          }}
      ...
      <div className="relative" style={{ zIndex: 1 }}>
        ...
        <motion.nav
          ...
          className="w-full   flex items-center justify-self-center justify-between px-8 md:px-12 py-5"
          style={{
          ...
          <div className="flex items-center gap-2.5">
            <div
              ...
              style={{
                ...
                boxShadow: "0 2px 10px rgba(91,79,207,0.3)",
              }}
            >
              <svg width="17" height="17" viewBox="0 0 17 17" fill="none">
                ...
                <path
                  d="M4 6 Q4 8.5 8.5 8.5 Q13 8.5 13 6"
                  stroke="white"
                  strokeWidth="1.4"
                  strokeOpacity="0.55"
                  fill="none"
          ...
          {/* <div className="hidden md:flex items-center gap-7">
            {["Features", "Docs", "Changelog"].map((item) => (
              <a
                ...
                onMouseLeave={(e) => (e.currentTarget.style.color = "#7e7a9a")}
              >
                {item}
              </a>
            ))}
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                "0 4px 18px rgba(91,79,207,0.38)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = "translateY(0)";
              e.currentTarget.style.boxShadow =
                "0 2px 12px rgba(91,79,207,0.28)";
            }}
            ...
            <div>
              ...
              >
                ...
                <span
                  style={{
                    background:
                      "linear-gradient(135deg, #7c6ef5 0%, #e879a0 60%, #f97316 100%)",
              ...
              >
                ...
                Explore structure, understand architecture, and navigate
                unfamiliar codebases — in seconds.
              </p>
            </div>
        ...
        <div className="w-full max-w-6xl mx-auto px-8 md:px-12">
          <div
            style={{
              height: "1px",
              background:
                "linear-gradient(90deg, transparent, rgba(91,79,207,0.12), transparent)",
            }}
          />
        </div>
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, #7c6ef5 0%, #5b4fcf 50%, #4338ca 100%)",
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                ...
                <path
                  d="M3 4.5 Q3 6.5 6.5 6.5 Q10 6.5 10 4.5"
                  stroke="white"
                  strokeWidth="1.2"
                  strokeOpacity="0.5"
                  fill="none"
          ...
          <div className="flex gap-5">
            {["Privacy", "Terms", "GitHub"].map((label) => (
              <a
                ...
                onMouseEnter={(e) => (e.currentTarget.style.color = "#5b4fcf")}
