    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(251,182,206,0.3) 0%, transparent 70%)",
          bottom: -30,
          right: -30,
          filter: "blur(24px)",
        }}
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(110,231,183,0.22) 0%, transparent 70%)",
          bottom: 40,
          left: -20,
          filter: "blur(20px)",
        }}
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 8px 40px rgba(91,79,207,0.1), 0 2px 8px rgba(91,79,207,0.06)",
        }}
      >
        {/* Logo cluster */}
        <div className="flex items-center gap-4">
          ...
          >
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
              ...
              <path
                d="M7 10 Q7 14 14 14 Q21 14 21 10"
                stroke="white"
                strokeWidth="1.8"
                strokeOpacity="0.5"
                fill="none"
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex justify-start">
            ...
            >
              ...
              >
                <span style={{ color: "#a09dc0" }}>src/auth/</span> handles JWT
                validation, session management &amp; OAuth2 flows via a
          ...
          {/* Typing indicator */}
          <div
            className="flex justify-start items-center gap-1.5 px-4 py-3 rounded-2xl rounded-tl-sm w-fit"
            style={{
              background: "#f3f1fb",
              border: "1px solid rgba(91,79,207,0.1)",
            }}
